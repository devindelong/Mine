...
Mine directory to a new name, and then manually replace Mine
...
To load the plugin with specific settings, use the format:
  -loadplugin Mine,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin Mine,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin Mine,<configfilename>
For example:
  -loadplugin Mine,/path/to/my/sampleplugin.cfg
